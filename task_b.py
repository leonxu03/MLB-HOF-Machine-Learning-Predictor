...
def main():
    ...
    param_grid = {'max_depth': [1, 2, 3, 4], 'min_samples_split': [2, 3, 5, 7, 10], 'min_samples_leaf': [1, 3, 5, 7, 10]}
    ...
    plt.savefig("confusion_matrix_b.png", dpi=500)
    plt.close()
    
    plt.figure(figsize=(20,8))
    plot_tree(grid_model.best_estimator_, fontsize=7)
    plt.savefig("tree_plot_b.png", dpi=300, bbox_inches='tight')
